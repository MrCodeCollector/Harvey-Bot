...
const app = express();
const Wit = require('node-wit').Wit; //  Wit.ai object
...
if (!FB_PAGE_ID) {
  ...
  console.log("FB PAGE ID: CORRECT!");
}
...
if (!FB_PAGE_TOKEN) {
  ...
  console.log("FB PAGE TOKEN: CORRECT!");
}
...
const WundergroundWeather = (loc, cb) => {
    ...
    const URL = "http://api.wunderground.com/api/461aebd047dd17e7/forecast/q/CA/" + loc + ".json"; // API call
    console.log(URL);
